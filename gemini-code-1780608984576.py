...
def cargar_y_procesar_datos(archivo_subido):
    ...
    if col_medico in df.columns:
        ...
        # Filtro para limpiar los "falsos médicos" que vimos en la gráfica
    ...
    # Borrar filas que estén mayormente vacías (menos de 3 columnas con datos reales)
    df.dropna(thresh=3, inplace=True)
        
    # Calcular productividad final
...
if archivo_subido is not None:
    try:
        ...
        if df.empty:
            ...
            # --- SECCIÓN DE DEPURACIÓN PARA VER QUÉ ESTÁ LEYENDO ---
